...
public interface Soap {
    ...
    @RequestWrapper(localName = "borrarTabla", targetNamespace = "http://webservices/", className = "clientes.BorrarTabla")
    @ResponseWrapper(localName = "borrarTablaResponse", targetNamespace = "http://webservices/", className = "clientes.BorrarTablaResponse")
    @Action(input = "http://webservices/Soap/borrarTablaRequest", output = "http://webservices/Soap/borrarTablaResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "mostrarTablas", targetNamespace = "http://webservices/", className = "clientes.MostrarTablas")
    @ResponseWrapper(localName = "mostrarTablasResponse", targetNamespace = "http://webservices/", className = "clientes.MostrarTablasResponse")
    @Action(input = "http://webservices/Soap/mostrarTablasRequest", output = "http://webservices/Soap/mostrarTablasResponse")
